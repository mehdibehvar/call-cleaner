...
const inputVariants = cva(
  'w-full bg-gray-50 border-none outline-none transition-colors duration-200 placeholder:text-gray-bd placeholder:text-xs focus:border-primary focus:ring-1 focus:ring-primary disabled:bg-gray-light disabled:text-gray-4 disabled:cursor-not-allowed',
  {
    variants: {
      variant: {
        default: 'rounded-sm',
