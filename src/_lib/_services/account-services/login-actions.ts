...
import { authRoutes } from "@/lib/api/routes";
...
export const signUpUser = async (prevState: ActionResponse | undefined, formData: FormData): Promise<ActionResponse> => {
...
export const signInUser = async (
  ...
  const res = await post<UserHttp>(authRoutes.loginWithPassword, { mobile, password });
  if(res.ok){
